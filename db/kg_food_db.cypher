...
// Ingredient
CREATE (chicken:Ingredient:Protein {name: 'Chicken'})
...
CREATE (pig_trotter:Ingredient:Protein {name: 'Pig Trotter'})
...
CREATE (tenderloin:Ingredient:Protein {name: 'Tenderloin'})
...
CREATE (pork:Ingredient:Protein {name: 'Pork'})
CREATE (egg:Ingredient:Wet {name: 'Egg'})
CREATE (chicken_essence:Ingredient:Wet {name: 'Chicken Essence'})
CREATE (duck:Ingredient:Protein {name: 'Duck'})
CREATE (shallot_oil:Ingredient:Oil {name: 'Shallot Oil'})
CREATE (taro:Ingredient:Carbohydrate {name: 'Betel Nut Taro'})
CREATE (lettuce:Ingredient:Vegetable {name: 'Lettuce'})
CREATE (clear_soup:Ingredient:Wet {name: 'Clear Soup'})
CREATE (yellow_croaker:Ingredient:Seafood {name: 'Yellow Croaker'})
CREATE (tofu:Ingredient:Protein {name: 'Tofu'})
CREATE (enoki_mushroom:Ingredient:Vegetable {name: 'Enoki Mushroom'})
CREATE (chinese_cabbage:Ingredient:Vegetable {name: 'Chinese Cabbage'})
CREATE (chives:Ingredient:Dry {name: 'Chives'})
CREATE (rapeseed:Ingredient:Vegetable {name: 'Rapeseed'})
CREATE (carrot:Ingredient:Vegetable {name: 'Carrot'})
CREATE (oil:Ingredient:Oil {name: 'Oil'})
CREATE (minced_meat:Ingredient:Protein {name: 'Minced Meat'})
CREATE (shallot:Ingredient:Dry {name: 'Shallot'})
CREATE (roast_yan:Ingredient:Protein {name: 'Roast Yan'})
CREATE (abalone:Ingredient:Seafood {name: 'Abalone'})
CREATE (scallops:Ingredient:Seafood {name: 'Scallops'})
CREATE (sea_cucumber:Ingredient:Protein {name: 'Sea Cucumber'})
CREATE (green_radish:Ingredient:Vegetable {name: 'Green Radish'})
CREATE (pig_tendon:Ingredient:Protein {name: 'Pig Tendon'})
CREATE (quail_egg:Ingredient:Protein {name: 'Quail Egg'})
CREATE (fish_maw:Ingredient:Seafood {name: 'Fish Maw'})
CREATE (vegetarian_shark_fin:Ingredient:Seafood {name: 'Vegetarian Shark Fin'})
CREATE (shaoxing_wine:Ingredient:Wine {name: 'Shaoxing Wine'})
CREATE (cinnamon:Ingredient:Dry {name: 'Cinnamon'})
CREATE (pork_leg_bone:Ingredient:Protein {name: 'Pork Leg Bone'})
CREATE (pork_hip_bone:Ingredient:Protein {name: 'Pork Hip Bone'})
CREATE (chicken_feet:Ingredient:Protein {name: 'Chicken Feet'})
CREATE (pork_belly:Ingredient:Protein {name: 'Pork Belly'})
CREATE (jinhua_ham:Ingredient:Protein {name: 'Jin Hua Ham'})
...
CREATE (shrimp:Ingredient:Seafood {name: 'Shrimp'})
...
CREATE (mackerel:Ingredient:Seafood {name: 'Mackerel'})
CREATE (noodle:Ingredient:Carbohydrate {name: 'Noodle'})
CREATE (white_wine:Ingredient:Wine {name: 'white_wine'})
CREATE (green_pepper:Ingredient:Vegetable {name: 'Green Pepper'})
CREATE (red_pepper:Ingredient:Vegetable {name: 'Red Repper'})
CREATE (lala:Ingredient:Seafood {name: 'La La'})
...
CREATE (oyster:Ingredient:Seafood {name: 'Oyster'})
...
CREATE (dried_bamboo_shoots:Ingredient:Vegetable {name: 'Dried Bamboo Shoots'})
CREATE (bitter_gourd:Ingredient:Vegetable {name: 'Bitter Gourd'})
...
CREATE (seaweed:Ingredient:Vegetable {name: 'seaweed'})
CREATE (white_pepper:Ingredient:Dry {name: 'White Pepper'})
CREATE (flour:Ingredient:Dry {name: 'Flour'})
CREATE (pig_intestine:Ingredient:Protein {name: 'Pig Intestine'})
CREATE (lard:Ingredient:Oil {name: 'lard'})
CREATE (toushui_laver:Ingredient:Wet {name: 'Toushui Laver'})
CREATE (spinach:Ingredient:Vegetable {name: 'Amaranth'})
CREATE (preserved_egg:Ingredient:Protein {name: 'Preserved Egg'})
CREATE (salted_egg:Ingredient:Protein {name: 'Salted Egg'})
CREATE (white_vinegar:Ingredient:Wet {name: 'White Vinegar'})
CREATE (soy_bean_paste:Ingredient:Wet {name: 'Soy Bean Paste'})
CREATE (shanshui_tofu:Ingredient:Protein {name: 'Shanshui Tofu'})
CREATE (bean_bun:Ingredient:Carbohydrate {name: 'Bean Bun'})
CREATE (kale:Ingredient:Vegetable {name: 'kale'})
CREATE (shrimp_paste_noodles:Ingredient:Carbohydrate {name: 'Shrimp Paste Noodles'})
CREATE (leek:Ingredient:Vegetable {name: 'leek'})
CREATE (black_fungus:Ingredient:Vegetable {name: 'Black Fungus'})
CREATE (xinghua_rice_noodles:Carbohydrate {name: 'Xinghua Rice Noodles'})
CREATE (shiitake_mushroom:Ingredient:Vegetable {name: 'shiitake_mushroom'})
CREATE (rice:Ingredient:Carbohydrate {name: 'Rice'})
CREATE (dried_shrimp:Ingredient:Dry {name: 'Dried Shrimp'})
CREATE (fried_octopus:Ingredient:Seafood {name: 'Fried Octopus'})
CREATE (fried_squid:Ingredient:Seafood {name: 'Fried Squid'})
CREATE (shanghai_green:Ingredient:Vegetable {name: 'Shanghai Green'})

// Dish
CREATE (chick_garlic:Dish:Meat {id:1, name: 'Deep Fried Chicken with Garlic', image: 'https://www.putien.com/wp-content/uploads/2021/03/%E8%92%9C%E9%A6%99%E9%B8%A1.jpg'})
CREATE (pork_salt_pepper:Dish:Meat {id:2, name: 'Deep Fried Pork Trotter with Salt and Pepper', image: 'https://www.putien.com/wp-content/uploads/2021/03/%E7%8C%AA%E6%89%8B.jpg'})
CREATE (pork_sesame_bun:Dish:Meat {id:3, name: 'Shredded Pork with Sesame Bun', image: 'https://www.putien.com/wp-content/uploads/2021/03/%E9%BB%84%E9%87%91%E8%8D%B7%E5%8F%B6%E5%8C%85-1.jpg'})
CREATE (pork_lychee:Dish:Meat {id:4, name: 'Sweet and sour pork with lychee', image: 'https://www.putien.com/wp-content/uploads/2021/03/%E8%8D%94%E6%9E%9D%E8%82%89.jpg'})
CREATE (duck_yam:Dish:Meat {id:5, name: 'Deep Fried Duck with Yam', image: 'https://www.putien.com/wp-content/uploads/2021/03/%E8%8A%8B%E9%A6%99%E9%B8%AD-1.jpg'})

CREATE (claypot_croaker:Dish:Soup {id:6, name: 'Claypot Yellow Croaker Soup', image: 'https://www.putien.com/wp-content/uploads/2021/03/%E7%A0%82%E9%94%85%E9%BB%84%E8%8A%B1%E9%B1%BC%E6%B1%A4.jpg'})
CREATE (beancurd_cabbage:Dish:Soup {id:7, name: 'Braised Beancurd with Chinese Cabbage', image: 'https://www.putien.com/wp-content/uploads/2021/03/%E7%9A%87%E7%99%BD%E8%8F%9C%E7%82%96%E8%BD%AF%E8%B1%86%E8%85%90.jpg'})
CREATE (bian_rou:Dish:Soup {id:8, name: 'Bian Rou Soup', image: 'https://www.putien.com/wp-content/uploads/2021/03/%E6%89%81%E8%82%89%E6%B1%A4.jpg'})
CREATE (buddha:Dish:Soup {id:9, name: 'Buddha Jumps over the Wall', image: 'https://www.putien.com/wp-content/uploads/2021/03/%E4%BD%9B%E8%B7%B3%E5%A2%99.jpg'})

CREATE (hundard_second:Dish:Seafood {id:10, name: '100-Second Stewed Yellow Croaker', image: 'https://www.putien.com/wp-content/uploads/2021/03/%E7%99%BE%E7%A7%92%E9%BB%84%E8%8A%B1%E9%B1%BC.jpg'})
CREATE (pan_fried_croaker:Dish:Seafood {id:11, name: 'Pan-fried Yellow Croakers', image: 'https://www.putien.com/wp-content/uploads/2020/07/14.jpg'})
CREATE (herbal_prawn:Dish:Seafood {id:12, name: 'Herbal Tiger Prawn', image: 'https://www.putien.com/wp-content/uploads/2021/03/%E9%85%92%E9%A6%99%E8%8D%AF%E8%86%B3%E8%99%BE.jpg'})
CREATE (deep_fried_tenggiri:Dish:Seafood {id:13, name: 'Deep-fried Tenggiri Fish', image: 'https://www.putien.com/wp-content/uploads/2021/03/%E9%A9%AC%E9%B2%9B%E9%B1%BC.jpg'})
CREATE (steamed_prawn:Dish:Seafood {id:14, name: 'Steamed Prawn with Minced Garlic', image: 'https://www.putien.com/wp-content/uploads/2021/03/%E8%92%9C%E8%93%89%E8%92%B8%E8%99%BE.jpg'})
CREATE (chili_clams:Dish:Seafood {id:15, name: 'Stir-fried Chilli Clams', image: 'https://www.putien.com/wp-content/uploads/2021/03/%E8%BE%A3%E6%B1%81%E5%95%A6%E5%95%A6.jpg'})
CREATE (crispy_oyster:Dish:Seafood {id:16, name: 'Crispy Oyster', image: 'https://www.putien.com/wp-content/uploads/2021/03/%E4%B8%80%E5%93%81%E6%B5%B7%E8%9B%8E%E7%85%8E.jpg'})

CREATE (bamboo_shoot:Dish:Starter {id:17, name: 'Braised Bamboo Shoot', image: 'https://www.putien.com/wp-content/uploads/2021/03/%E5%AE%B6%E5%B8%B8%E7%84%96%E7%AC%8B%E5%B9%B2.jpg'})
CREATE (iced_bitter_gourd:Dish:Starter {id:18, name: 'Iced Bitter Gourd', image: 'https://www.putien.com/wp-content/uploads/2020/07/07.jpg'})
CREATE (starter:Dish:Starter {id:19, name: 'Starters Platter', image: 'https://www.putien.com/wp-content/uploads/2021/03/%E5%9B%9B%E5%B0%8F%E6%8B%BC.jpg'})
CREATE (drunken_cockle:Dish:Starter {id:20, name: 'Drunken Cockles', image: 'https://www.putien.com/wp-content/uploads/2020/05/cockles2.jpg'})
CREATE (deep_fried_croaker:Dish:Starter {id:21, name: 'Deep-fried Yellow Croaker', image: 'https://www.putien.com/wp-content/uploads/2021/03/%E5%92%B8%E9%A6%99%E9%85%A5%E8%84%86%E9%BB%84%E8%8A%B1%E9%B1%BC.jpg'})
CREATE (braised_intestine:Dish:Starter {id:22, name: 'Braised Pig Intestine', image: 'https://www.putien.com/wp-content/uploads/2021/03/%E4%B9%9D%E8%BD%AC%E5%B0%8F%E8%82%A0.jpg'})
CREATE (ice_abalone:Dish:Starter {id:23, name: 'Iced Nanri Abalone', image: 'https://www.putien.com/wp-content/uploads/2021/03/%E5%8D%97%E6%97%A5%E9%B2%8D.jpg'})
CREATE (pork_trotter:Dish:Starter {id:24, name: 'Cold Pork Trotters Jelly', image: 'https://www.putien.com/wp-content/uploads/2021/03/%E6%B0%B4%E6%99%B6%E7%8C%AA%E8%B9%84%E5%86%BB.jpg'})
CREATE (seaweed_shrimps:Dish:Starter {id:25, name: 'Seaweed with Mini Shrimps Dressed with Sauce', image: 'https://www.putien.com/wp-content/uploads/2021/03/%E5%A4%B4%E6%B0%B4%E7%B4%AB%E8%8F%9C.jpg'})

CREATE (loquat_jelly:Dish:Dessert {id:26, name: 'Chilled Loquat in Herbal Jelly', image: 'https://www.putien.com/wp-content/uploads/2021/03/%E6%9E%87%E6%9D%B7%E5%86%BB-1.jpg'})
CREATE (lotus_seed_fungus:Dish:Dessert {id:27, name: 'Lotus Seed with White Fungus Soup', image: 'https://www.putien.com/wp-content/uploads/2021/03/%E8%8E%B2%E5%AD%90%E9%9B%AA%E8%80%B3%E6%B1%A4-1.jpg'})
CREATE (pear_osmanthus:Dish:Dessert {id:28, name: 'Double-boiled Pear with Osmanthus and Aged Mandarin Peel', image: 'https://www.putien.com/wp-content/uploads/2021/03/%E6%A1%82%E8%8A%B1%E9%99%88%E7%9A%AE%E7%82%96%E9%9B%AA%E6%A2%A8.jpg'})
CREATE (durian_puree:Dish:Dessert {id:29, name: 'Deep-fried Durian Puree', image: 'https://www.putien.com/wp-content/uploads/2021/03/%E5%86%B0%E5%BF%83%E6%A6%B4%E8%8E%B2.jpg'})

CREATE (spinach_stock:Dish:Vegetable {id:30, name: 'Spinach in Supreme Stock', image: 'https://www.putien.com/wp-content/uploads/2021/03/%E4%B8%8A%E6%B1%A4%E8%8B%8B%E8%8F%9C.jpg'})
CREATE (stir_fried_yam:Dish:Vegetable {id:31, name: 'Stir-fried Yam', image: 'https://www.putien.com/wp-content/uploads/2021/03/%E8%8A%8B%E8%8A%AF.jpg'})
CREATE (braised_bitter_gourd:Dish:Vegetable {id:32, name: 'Braised Bitter Gourd', image: 'https://www.putien.com/wp-content/uploads/2021/03/%E9%A3%8E%E5%91%B3%E7%84%96%E8%8B%A6%E7%93%9C.jpg'})
CREATE (homemade_bean_curd:Dish:Vegetable {id:33, name: 'Hot Plate Homemade Bean Curd', image: 'https://www.putien.com/wp-content/uploads/2021/03/%E9%93%81%E6%9D%BF%E6%BB%91%E8%B1%86%E8%85%90.jpg'})
CREATE (kailan_bean_curd:Dish:Vegetable {id:34, name: 'Stir-fried Kailan with Bean Curd Skin', image: 'https://www.putien.com/wp-content/uploads/2021/03/%E8%8A%A5%E5%85%B0%E8%B1%86%E7%9A%AE-1.jpg'})

CREATE (mushroom_seafood_lor_mee:Dish:Main {id:35, name: 'Fujian Red Mushroom Seafood Lor Mee', image: 'https://www.putien.com/wp-content/uploads/2021/03/%E7%BA%A2%E8%8F%87%E5%8D%A4%E9%9D%A2.jpg'})
CREATE (heng_hua_bee_hoon:Dish:Main {id:36, name: 'Fried Heng Hwa Bee Hoon', image:'https://www.putien.com/wp-content/uploads/2021/03/%E5%85%B4%E5%8C%96%E7%82%92%E7%B1%B3%E7%B2%89-1.jpg'})
CREATE (cabbage_rice:Dish:Main {id:37, name: 'Cabbage Rice', image:'https://www.putien.com/wp-content/uploads/2021/03/%E5%8C%85%E8%8F%9C%E9%A5%AD.jpg'})
CREATE (ca_fan:Dish:Main {id:38, name: 'PUTIEN Ca Fen', image:'https://www.putien.com/wp-content/uploads/2021/03/%E5%86%9C%E5%AE%B6%E6%93%A6%E7%B2%89-1.jpg'})

CREATE (ba_hong_bao:Dish:Drink {id:39, name: 'Wuyi Mountain Early Spring Da Hong Pao', alcohol:false, type:["Hot"], image: 'https://www.putien.com/wp-content/uploads/2020/07/50.jpg'})
CREATE (barley:Dish:Drink {id:40, name: 'Pearl Barley with Winter Melon', alcohol:false, type:["Hot", "Cold"], image: 'https://www.putien.com/wp-content/uploads/2020/07/53.jpg'})
CREATE (baybery_tea:Dish:Drink {id:41, name: 'Bayberry Tea with Iced Berry Cubes', alcohol:false, type:["Hot", "Cold"], image: 'https://www.putien.com/wp-content/uploads/2021/03/%E5%86%B0%E7%A0%96%E6%9D%A8%E6%A2%85%E6%B0%B4.jpg'})
CREATE (chrysanthemum:Dish:Drink {id:42, name: 'Chrysanthemum Tea', alcohol:false, type:["Hot", "Cold"], image: 'https://www.putien.com/wp-content/uploads/2021/03/%E8%83%8E%E8%8F%8A%E8%8C%B6-1.jpg'})
CREATE (corn_juice:Dish:Drink {id:43, name: 'Sweet Corn Juice', alcohol:false, type:["Cold"], image: 'https://www.putien.com/wp-content/uploads/2020/07/54.jpg'})
CREATE (soursop:Dish:Drink {id:44, name: 'Soursop Juice', alcohol:false, type:["Cold"], image: 'https://www.putien.com/wp-content/uploads/2020/07/55.jpg'})
CREATE (sprite:Dish:Drink {id:45, name: 'Sprite', alcohol:false, type:["Cold"], image: 'https://www.putien.com/wp-content/uploads/2020/07/62.jpg'})
CREATE (coke:Dish:Drink {id:46, name: 'Coke', alcohol:false, type:["Cold"], image: 'https://www.putien.com/wp-content/uploads/2020/07/61.jpg'})
CREATE (tiger:Dish:Drink {id:47, name: 'Tiger beer', alcohol:true, type:["Cold"], image: 'https://www.putien.com/wp-content/uploads/2020/07/64.jpg'})
CREATE (mineral_water:Dish:Drink {id:48, name: 'Mineral Water', alcohol:false, type:["Cold"], image: 'https://www.putien.com/wp-content/uploads/2020/07/63.jpg'})
CREATE (white_beer:Dish:Drink {id:49, name: '1664 White Beer', alcohol:true, type:["Cold"], image: 'https://www.putien.com/wp-content/uploads/2020/07/65.jpg'})
CREATE (hoegaarden:Dish:Drink {id:50, name: 'Hoegaarden', alcohol:true, type:["Cold"], image: 'https://www.putien.com/wp-content/uploads/2020/07/66.jpg'})
CREATE (maotai:Dish:Drink {id:51, name: 'Guizhou Maotai', alcohol:true, type:["Cold"], image: 'https://www.putien.com/wp-content/uploads/2020/07/68.jpg'})
