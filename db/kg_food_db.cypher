...
// Dish
CREATE (chick_garlic:Dish:Meat:Fried {price:12.90, category:'Meat', name: 'Deep Fried Chicken with Garlic', image: 'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/%E8%92%9C%E9%A6%99%E9%B8%A1.jpeg?alt=media'})
CREATE (pork_salt_pepper:Dish:Meat:Fried {price:12.90, category:'Meat', name: 'Deep Fried Pork Trotter with Salt and Pepper', image: 'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/%E7%8C%AA%E6%89%8B.jpeg?alt=media'})
CREATE (pork_sesame_bun:Dish:Meat {price:10.90, category:'Meat', name: 'Shredded Pork with Sesame Bun', image: 'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/%E9%BB%84%E9%87%91%E8%8D%B7%E5%8F%B6%E5%8C%85-1.jpeg?alt=media'})
CREATE (pork_lychee:Dish:Meat {price:15.90, category:'Meat', name: 'Sweet and sour pork with lychee', image: 'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/%E8%8D%94%E6%9E%9D%E8%82%89.jpeg?alt=media'})
CREATE (duck_yam:Dish:Meat:Fried {price:20.90, category:'Meat', name: 'Deep Fried Duck with Yam', image: 'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/%E8%8A%8B%E9%A6%99%E9%B8%AD-1.jpeg?alt=media'})

CREATE (claypot_croaker:Dish:Soup:NonFried {price:18.90, category:'Soup', name: 'Claypot Yellow Croaker Soup', image: 'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/%E7%A0%82%E9%94%85%E9%BB%84%E8%8A%B1%E9%B1%BC%E6%B1%A4.jpeg?alt=media'})
CREATE (beancurd_cabbage:Dish:Soup:NonFried {price:15.90, category:'Soup', name: 'Braised Beancurd with Chinese Cabbage', image: 'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/%E7%9A%87%E7%99%BD%E8%8F%9C%E7%82%96%E8%BD%AF%E8%B1%86%E8%85%90.jpeg?alt=media'})
CREATE (bian_rou:Dish:Soup:NonFried {price:12.90, category:'Soup', name: 'Bian Rou Soup', image: 'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/%E6%89%81%E8%82%89%E6%B1%A4.jpeg?alt=media'})
CREATE (buddha:Dish:Soup:NonFried {price:33.90, category:'Soup', name: 'Buddha Jumps over the Wall', image: 'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/%E4%BD%9B%E8%B7%B3%E5%A2%99.jpeg?alt=media'})

CREATE (hundard_second:Dish:Seafood:NonFried {price:20.90, category:'Seafood', name: '100-Second Stewed Yellow Croaker', image: 'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/%E7%99%BE%E7%A7%92%E9%BB%84%E8%8A%B1%E9%B1%BC.jpeg?alt=media'})
CREATE (pan_fried_croaker:Dish:Seafood:Fried {price:18.90, category:'Seafood', name: 'Pan-fried Yellow Croakers', image: 'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/14.jpeg?alt=media'})
CREATE (herbal_prawn:Dish:Seafood:NonFried {price:18.90, category:'Seafood', name: 'Herbal Tiger Prawn', image: 'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/%E9%85%92%E9%A6%99%E8%8D%AF%E8%86%B3%E8%99%BE.jpeg?alt=media'})
CREATE (deep_fried_tenggiri:Dish:Seafood:Fried {price:21.90, category:'Seafood', name: 'Deep-fried Tenggiri Fish', image: 'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/%E9%A9%AC%E9%B2%9B%E9%B1%BC.jpeg?alt=media'})
CREATE (steamed_prawn:Dish:Seafood:NonFried {price:16.90, category:'Seafood', name: 'Steamed Prawn with Minced Garlic', image: 'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/%E8%92%9C%E8%93%89%E8%92%B8%E8%99%BE.jpeg?alt=media'})
CREATE (chili_clams:Dish:Seafood {price:21.90, category:'Seafood', name: 'Stir-fried Chilli Clams', image: 'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/%E8%BE%A3%E6%B1%81%E5%95%A6%E5%95%A6.jpeg?alt=media'})
CREATE (crispy_oyster:Dish:Seafood:Fried {price:21.90, category:'Seafood', name: 'Crispy Oyster', image: 'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/%E4%B8%80%E5%93%81%E6%B5%B7%E8%9B%8E%E7%85%8E.jpeg?alt=media'})

CREATE (bamboo_shoot:Dish:Starter {price:12.90, category:'Starter', name: 'Braised Bamboo Shoot', image: 'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/%E5%AE%B6%E5%B8%B8%E7%84%96%E7%AC%8B%E5%B9%B2.jpeg?alt=media'})
CREATE (iced_bitter_gourd:Dish:Starter:NonFried {price:12.90, category:'Starter', name: 'Iced Bitter Gourd', image: 'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/07.jpeg?alt=media'})
CREATE (starter:Dish:Starter {price:12.90, category:'Starter', name: 'Starters Platter', image: 'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/%E5%9B%9B%E5%B0%8F%E6%8B%BC.jpeg?alt=media'})
CREATE (drunken_cockle:Dish:Starter:NonFried {price:12.90, category:'Starter', name: 'Drunken Cockles', image: 'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/2020/05/cockles2.jpeg?alt=media'})
CREATE (deep_fried_croaker:Dish:Starter:Fried {price:15.90, category:'Starter', name: 'Deep-fried Yellow Croaker', image: 'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/%E5%92%B8%E9%A6%99%E9%85%A5%E8%84%86%E9%BB%84%E8%8A%B1%E9%B1%BC.jpeg?alt=media'})
CREATE (braised_intestine:Dish:Starter {price:18.90, category:'Starter', name: 'Braised Pig Intestine', image: 'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/%E4%B9%9D%E8%BD%AC%E5%B0%8F%E8%82%A0.jpeg?alt=media'})
CREATE (ice_abalone:Dish:Starter:NonFried {price:20.90, category:'Starter', name: 'Iced Nanri Abalone', image: 'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/%E5%8D%97%E6%97%A5%E9%B2%8D.jpeg?alt=media'})
CREATE (pork_trotter:Dish:Starter:NonFried {price:12.90, category:'Starter', name: 'Cold Pork Trotters Jelly', image: 'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/%E6%B0%B4%E6%99%B6%E7%8C%AA%E8%B9%84%E5%86%BB.jpeg?alt=media'})
CREATE (seaweed_shrimps:Dish:Starter {price:15.90, category:'Starter', name: 'Seaweed with Mini Shrimps Dressed with Sauce', image: 'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/%E5%A4%B4%E6%B0%B4%E7%B4%AB%E8%8F%9C.jpeg?alt=media'})

CREATE (loquat_jelly:Dish:Dessert:NonFried {price:8.90, category:'Dessert', name: 'Chilled Loquat in Herbal Jelly', image: 'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/%E6%9E%87%E6%9D%B7%E5%86%BB-1.jpeg?alt=media'})
CREATE (lotus_seed_fungus:Dish:Dessert:NonFried {price:9.90, category:'Dessert', name: 'Lotus Seed with White Fungus Soup', image: 'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/%E8%8E%B2%E5%AD%90%E9%9B%AA%E8%80%B3%E6%B1%A4-1.jpeg?alt=media'})
CREATE (pear_osmanthus:Dish:Dessert:NonFried {price:5.90, category:'Dessert', name: 'Double-boiled Pear with Osmanthus and Aged Mandarin Peel', image: 'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/%E6%A1%82%E8%8A%B1%E9%99%88%E7%9A%AE%E7%82%96%E9%9B%AA%E6%A2%A8.jpeg?alt=media'})
CREATE (durian_puree:Dish:Dessert:Fried {price:8.90, category:'Dessert', name: 'Deep-fried Durian Puree', image: 'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/%E5%86%B0%E5%BF%83%E6%A6%B4%E8%8E%B2.jpeg?alt=media'})

CREATE (spinach_stock:Dish:Vegetable:NonFried {price:12.90, category:'Vegetable', name: 'Spinach in Supreme Stock', image: 'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/%E4%B8%8A%E6%B1%A4%E8%8B%8B%E8%8F%9C.jpeg?alt=media'})
CREATE (stir_fried_yam:Dish:Vegetable:Fried {price:12.90, category:'Vegetable', name: 'Stir-fried Yam', image: 'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/%E8%8A%8B%E8%8A%AF.jpeg?alt=media'})
CREATE (braised_bitter_gourd:Dish:Vegetable:NonFried {price:12.90, category:'Vegetable', name: 'Braised Bitter Gourd', image: 'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/%E9%A3%8E%E5%91%B3%E7%84%96%E8%8B%A6%E7%93%9C.jpeg?alt=media'})
CREATE (homemade_bean_curd:Dish:Vegetable:NonFried {price:10.90, category:'Vegetable', name: 'Hot Plate Homemade Bean Curd', image: 'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/%E9%93%81%E6%9D%BF%E6%BB%91%E8%B1%86%E8%85%90.jpeg?alt=media'})
CREATE (kailan_bean_curd:Dish:Vegetable:NonFried {price:15.90, category:'Vegetable', name: 'Stir-fried Kailan with Bean Curd Skin', image: 'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/%E8%8A%A5%E5%85%B0%E8%B1%86%E7%9A%AE-1.jpeg?alt=media'})

CREATE (mushroom_seafood_lor_mee:Dish:Main:NonFried {price:15.90, category:'Main', name: 'Fujian Red Mushroom Seafood Lor Mee', image: 'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/%E7%BA%A2%E8%8F%87%E5%8D%A4%E9%9D%A2.jpeg?alt=media'})
CREATE (heng_hua_bee_hoon:Dish:Main {price:17.90, category:'Main', name: 'Fried Heng Hwa Bee Hoon', image:'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/%E5%85%B4%E5%8C%96%E7%82%92%E7%B1%B3%E7%B2%89-1.jpeg?alt=media'})
CREATE (cabbage_rice:Dish:Main {price:15.90, category:'Main', name: 'Cabbage Rice', image:'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/%E5%8C%85%E8%8F%9C%E9%A5%AD.jpeg?alt=media'})
CREATE (ca_fan:Dish:Main {price:17.90, category:'Main', name: 'PUTIEN Ca Fen', image:'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/%E5%86%9C%E5%AE%B6%E6%93%A6%E7%B2%89-1.jpeg?alt=media'})

CREATE (ba_hong_bao:Dish:Drink {price:2.90, category:'Drink', name: 'Wuyi Mountain Early Spring Da Hong Pao', alcohol:false, type:["Hot"], image: 'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/50.jpeg?alt=media'})
CREATE (barley:Dish:Drink {price:2.90, category:'Drink', name: 'Pearl Barley with Winter Melon', alcohol:false, type:["Hot", "Cold"], image: 'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/53.jpeg?alt=media'})
CREATE (baybery_tea:Dish:Drink {price:5.90, category:'Drink', name: 'Bayberry Tea with Iced Berry Cubes', alcohol:false, type:["Hot", "Cold"], image: 'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/%E5%86%B0%E7%A0%96%E6%9D%A8%E6%A2%85%E6%B0%B4.jpeg?alt=media'})
CREATE (chrysanthemum:Dish:Drink {price:2.90, category:'Drink', name: 'Chrysanthemum Tea', alcohol:false, type:["Hot", "Cold"], image: 'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/%E8%83%8E%E8%8F%8A%E8%8C%B6-1.jpeg?alt=media'})
CREATE (corn_juice:Dish:Drink {price:2.90, category:'Drink', name: 'Sweet Corn Juice', alcohol:false, type:["Cold"], image: 'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/54.jpeg?alt=media'})
CREATE (soursop:Dish:Drink {price:2.90, category:'Drink', name: 'Soursop Juice', alcohol:false, type:["Cold"], image: 'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/55.jpeg?alt=media'})
CREATE (sprite:Dish:Drink {price:1.90, category:'Drink', name: 'Sprite', alcohol:false, type:["Cold"], image: 'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/62.jpeg?alt=media'})
CREATE (coke:Dish:Drink {price:1.90, category:'Drink', name: 'Coke', alcohol:false, type:["Cold"], image: 'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/61.jpeg?alt=media'})
CREATE (tiger:Dish:Drink:Alcohol {price:10.90, category:'Drink', name: 'Tiger beer', alcohol:true, type:["Cold"], image: 'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/64.jpeg?alt=media'})
CREATE (mineral_water:Dish:Drink:Alcohol {price:1.90, category:'Drink', name: 'Mineral Water', alcohol:false, type:["Cold"], image: 'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/63.jpeg?alt=media'})
CREATE (white_beer:Dish:Drink:Alcohol {price:10.90, category:'Drink', name: '1664 White Beer', alcohol:true, type:["Cold"], image: 'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/65.jpeg?alt=media'})
CREATE (hoegaarden:Dish:Drink:Alcohol {price:10.90, category:'Drink', name: 'Hoegaarden', alcohol:true, type:["Cold"], image: 'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/66.jpeg?alt=media'})
CREATE (maotai:Dish:Drink:Alcohol {price:15.90, category:'Drink', name: 'Guizhou Maotai', alcohol:true, type:["Cold"], image: 'https://firebasestorage.googleapis.com/v0/b/kg-food.appspot.com/o/68.jpeg?alt=media'})
